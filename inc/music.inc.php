...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#updatepl").click(function(event) {

            $.get('lib/music.php?a=updatepl', function() {
                window.location.reload();
            });
            event.preventDefault();
              ...
              <div class="btn-toolbar pull-left" role="navigation">
                  ...
                  <div class="btn-group">
                      ...
                      <?php if ($mpd->state == 'pause' || $mpd->state == 'stop'): ?>
                          <button type="button" id="play" title="Play" class="btn btn-default"><img src="images/media-play-pause-resume.png" alt="Play" /></button>
      <?php else: ?>
                          <button type="button" id="pause" title="Pause" class="btn btn-default"><img src="images/media-pause.png" alt="Pause" /></button>
      <?php endif; ?>
        ...
        <div class="panel-footer">
            <div class="btn-toolbar pull-right">
                <button id="updatepl" title="Update playlist" type="button" class="btn btn-default"><img src="images/media-repeat.png" alt="Update Playlist" /></button>
